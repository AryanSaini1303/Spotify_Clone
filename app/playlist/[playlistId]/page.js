...
import getCurrentPlaylist from "@/data/currentPlaylist";
...
export default async function HomePage({params}) {
  ...
  const currentPlaylistInfo=await getCurrentPlaylist(params.playlistId);
  // console.log(currentPlaylistInfo);
  return (
    <>
      <Content playlists={playlists} playlistPosters={playlistPosters} num={numOfSongsPlaylist} currPlayInfo={currentPlaylistInfo}/>
    </>
  );
}
